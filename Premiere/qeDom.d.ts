// ----------------- DISCLAIMER -------------------
// The Premiere Pro QE DOM is officially UNSUPPORTED/
...
interface QETrackItem {
   ...
   * @param unknown can leave a blank string
...
interface Sequence {
  ...
  exportFrameTarga(timecode: string, filePath: string): any
  exportFrameJPEG(timecode: string, filePath: string): any
  exportFrameTIFF(timecode: string, filePath: string): any
  flushCache(): any
}
interface Time {
  ticks: number
